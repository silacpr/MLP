...
public class MainFashion {
    public static void main(String[] args) throws IOException {
        ...
        File ftest_img = new File("./FASHION/train-images-idx3-ubyte");
        File ft10k_img = new File("./FASHION/t10k-images-idx3-ubyte");


        File ftest_etiquette = new File("./FASHION/train-labels-idx1-ubyte");
        File ft10k_etiquette= new File("./FASHION/t10k-labels-idx1-ubyte");
